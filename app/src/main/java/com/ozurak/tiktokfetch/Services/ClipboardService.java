...
import com.ozurak.tiktokfetch.Activity.MainActivity;
...
public class ClipboardService extends Service implements OnPrimaryClipChangedListener {
    ...
    private void showNotification() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, "TikFetch")
                .setStyle(new NotificationCompat.BigTextStyle().bigText(getString(R.string.link_for_download)))
                .setContentIntent(PendingIntent.getActivity(this, 0, getNotificationIntent(), PendingIntent.FLAG_UPDATE_CURRENT))
                .setSmallIcon(R.drawable.tiktokfetch_logo)
                .setTicker(getString(R.string.link_for_download))
                .setContentTitle(getString(R.string.link_founded))
                .setContentText(getString(R.string.link_for_download))
        ...
        try {
            if (mClipboardManager != null) {
                ...
                if (link != null) {
                    ...
                    if (mClipboardUrl.contains("vm.tiktok.com/")) {
                        showNotification();
                    }
                }
            }
